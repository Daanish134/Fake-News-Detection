          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              { 
                name: "Mikhil Sai N", 
                role: "Lead Engineer", 
                img: "/images/Mikhil.png",
                github: "https://github.com/MIKHILSAI",
                linkedin: "https://www.linkedin.com/in/mikhilsain/"
              },
              { 
                name: "Pooja S S", 
                role: "AI Architecture", 
                img: "/images/pooja.png",
                github: "https://github.com/Viswa-pro-coder",
              ...
              { 
                ...
                github: "https://github.com/DEEPAK-1546",
                linkedin: "https://www.linkedin.com/in/deepakr15/"
              },
              { 
                name: "Mohammed Daanish", 
                role: "Backend Architect", 
                img: "/images/Daanish.png",
                github: "https://github.com/Daanish134",
                linkedin: "https://www.linkedin.com/in/mohammed-daanish-028382218/"
              },
            ].map((member, idx) => (
              <div
                key={idx}
      ...
      <footer className="py-24 px-6 border-t border-white/5 bg-black">
        <div className="container max-w-7xl mx-auto">
          ...
          <div className="mt-24 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-slate-600 text-xs font-medium">
            <p>© 2026 S.P.E.C.T.R.A — Media analysis to support informed judgment.</p>
